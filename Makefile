...
run r:
	...
	@PORT=$(PORT) MONGO_URI="$(MONGO_URI)" JWT_KEY="$(JWT_KEY)" GOOGLE_CLIENT_SECRET="$(GOOGLE_CLIENT_SECRET)" HISTORY_URL="$(HISTORY_URL)" DEVICE_CONTROL_URL="$(DEVICE_CONTROL_URL)" GOOGLE_CLIENT_ID="$(GOOGLE_CLIENT_ID)" node src/index.js
